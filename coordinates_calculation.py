...
class CoordinatesCalculation(QtWidgets.QMainWindow):
    '''Расчёт координат по характеристикам изделия'''
    ...
    def get_target(self, stepper_number, target):
        return (
            (
                self.stepper_const[stepper_number]['l0']
                - (
                    self.stepper_const[stepper_number]['b']
                    * sin(
                        self.stepper_const[stepper_number]['alpha']
                        - asin(
                            int(target)
                            / (
                                2
                                * self.stepper_const[stepper_number]['length']
                            )
                        )
                    )
                    + sqrt(
                        ...
                        * pow(
                            sin(
                                ...
                                - asin(
                                    ...
                                    / (
                                        2
                                        * self.stepper_const[stepper_number][
                                            'length'
                                        ]
                                    )
                                )
    ...
    def get_cycle_target(self, stepper_number):
